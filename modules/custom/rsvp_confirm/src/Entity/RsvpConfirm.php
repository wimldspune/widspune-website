...
class RsvpConfirm extends ContentEntityBase implements RsvpConfirmInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['confirm'] = BaseFieldDefinition::create('boolean')
      ->setLabel(t('Status'))
    ...
    $fields['confirmation_date'] = BaseFieldDefinition::create('created')
      ->setLabel(t('Confirmed on'))
      ->setDescription(t('The time that the rsvp confirms.'))
      ->setDisplayOptions('view', [
        'label' => 'above',
        'type' => 'timestamp',
        'weight' => 20,
